...
public enum ModArmorMaterials implements ArmorMaterial {
    ECHO_NETHERITE("echo_netherite", 41, new int[]{5, 8, 10, 5}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
        return Ingredient.of(ModItems.ECHO_NETHERITE_INGOT.get());
    });
